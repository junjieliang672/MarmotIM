...
struct AppConfig: Codable {
    ...
    init(
        emptyCodeBehavior: EmptyCodeBehavior,
        ...
        customRankingFormula: String? = nil,
        fuzzyPinyin: FuzzyPinyinConfig = .default,
        enableAutoCommit: Bool,
        showCodeHint: Bool,
        frecencyMaxScore: Double,
        frecencyAgingFactor: Double
    ) {
        self.emptyCodeBehavior = emptyCodeBehavior
        self.enterKeyBehavior = enterKeyBehavior
        self.candidateCount = candidateCount
        self.pageKeys = pageKeys
        self.modeSwitchKey = modeSwitchKey
        ...
        self.customRankingFormula = customRankingFormula
        self.fuzzyPinyin = fuzzyPinyin
        self.enableAutoCommit = enableAutoCommit
        self.showCodeHint = showCodeHint
        self.frecencyMaxScore = frecencyMaxScore
        self.frecencyAgingFactor = frecencyAgingFactor
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        emptyCodeBehavior = (try? container.decode(EmptyCodeBehavior.self, forKey: .emptyCodeBehavior)) ?? d.emptyCodeBehavior
        ...
        pageKeys = (try? container.decode(PageKeyOption.self, forKey: .pageKeys)) ?? d.pageKeys
        modeSwitchKey = (try? container.decode(ModeSwitchKey.self, forKey: .modeSwitchKey)) ?? d.modeSwitchKey
        ...
        customRankingFormula = try? container.decode(String.self, forKey: .customRankingFormula)
        fuzzyPinyin = (try? container.decode(FuzzyPinyinConfig.self, forKey: .fuzzyPinyin)) ?? d.fuzzyPinyin
        enableAutoCommit = (try? container.decode(Bool.self, forKey: .enableAutoCommit)) ?? d.enableAutoCommit
        showCodeHint = (try? container.decode(Bool.self, forKey: .showCodeHint)) ?? d.showCodeHint
        frecencyMaxScore = (try? container.decode(Double.self, forKey: .frecencyMaxScore)) ?? d.frecencyMaxScore
        frecencyAgingFactor = (try? container.decode(Double.self, forKey: .frecencyAgingFactor)) ?? d.frecencyAgingFactor
    }
